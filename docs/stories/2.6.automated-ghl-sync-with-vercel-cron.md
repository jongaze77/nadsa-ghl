...
Cron jobs are automatically configured via `vercel.json` (requires Vercel Pro plan):
...
**Deployment**: Cron jobs activate automatically when deployed to Vercel with Pro plan
