...
- [ ] Task 1: Implement Surname Indexing System (AC: 1, 12)
  - [ ] Create surname extraction service to build indexed surname list from contact dataset
  - [ ] Implement efficient in-memory surname index with fuzzy matching capabilities
  - [ ] Add surname index initialization on reconciliation page load
  - [ ] Create surname normalization for common variations (MacDonald/McDonald, etc.)
  - [ ] Add performance monitoring and caching for surname index
  
- [ ] Task 2: Enhance MatchingService with Surname-Based Fuzzy Logic (AC: 2, 3, 11)
  - [ ] Modify MatchingService to use surname index for Lloyds description parsing
  - [ ] Implement fuzzy matching algorithm for surname detection in payment descriptions
  - [ ] Add forename enhancement logic including abbreviation matching (J Smith → John Smith)
  - [ ] Integrate enhanced surname matching with existing Levenshtein distance calculations
  - [ ] Update confidence scoring to weight surname matches appropriately
  - [ ] Add handling for partial matches and common name variations
  
- [ ] Task 3: Create Contact Pop-Out Interface (AC: 4, 5)
  - [ ] Design new contact detail view component with modern styling
  - [ ] Implement "pop out" functionality to open contact details in new tab
  - [ ] Create editable contact form using reconciliation dashboard design patterns
  - [ ] Add contact field editing capabilities with proper validation
  - [ ] Integrate contact update API calls with optimistic UI updates
  - [ ] Add proper error handling and success feedback for contact edits

- [ ] Task 4: Modernize /all-contacts Page and Modal (AC: 6, 7, 10)
  - [ ] Analyze current /all-contacts styling and identify improvement areas
  - [ ] Redesign /all-contacts page layout using reconciliation dashboard design patterns
  - [ ] Update contact list styling, filters, and pagination to match modern aesthetic
  - [ ] Redesign modal popup with improved layout and visual hierarchy
  - [ ] Ensure responsive design works across different screen sizes
  - [ ] Maintain all existing functionality while improving visual design

- [ ] Task 5: Modernize /users Page and User Management Interfaces (AC: 8, 9, 10)
  - [ ] Analyze current /users page styling and user management interfaces
  - [ ] Redesign /users page layout using reconciliation dashboard design patterns
  - [ ] Update user edit forms and interfaces with modern styling
  - [ ] Improve new user creation interface with consistent design
  - [ ] Add proper form validation feedback using modern UI patterns
  - [ ] Ensure all user management functionality is preserved

- [ ] Task 6: Testing and Performance Validation (AC: 11, 12)
  - [ ] Test surname indexing performance with contact dataset
  - [ ] Test fuzzy matching accuracy with various Lloyds description formats
  - [ ] Test pop-out contact interface functionality and editing capabilities
  - [ ] Test UI responsiveness and accessibility of modernized pages
  - [ ] Validate that all existing functionality is preserved after UI updates
  - [ ] Create unit tests for surname indexing and fuzzy matching logic
